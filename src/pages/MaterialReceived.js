...
const MaterialReceived = () => {
  ...
  useEffect(() => {
    const fetchDrawings = async () => {
      ...
      try {
        const response = await axios.get(`http://localhost:5000/materialRecieved/files/proj/${selectedProjectId}`);
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(`http://localhost:5000/materialRecieved/upload/${selectedProjectId}`, formData, {
        headers: {
      ...
      const drawingsResponse = await axios.get(`http://localhost:5000/materialRecieved/files/proj/${selectedProjectId}`);
  ...
  const downloadMainUpload = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/materialRecieved/download/mainFile/${id}`, {
        responseType: 'blob',
      });
  ...
  const downloadSitePic = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/materialRecieved/download/hw/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
  ...
  const downloadWooden = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/materialRecieved/download/wooden/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
  ...
  const downloadLights = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/materialRecieved/download/lights/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
  ...
  const downloadAccessories = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/materialRecieved/download/accessories/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
  ...
  const downloadChallan = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/materialRecieved/download/challan/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
  ...
  const downloadInvoice = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/materialRecieved/download/invoice/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
...
const viewMainUpload = (id) => {
  window.open(`http://localhost:5000/materialRecieved/view/mainFile/${id}`, '_blank');
};

const viewSitePic = (id) => {
  window.open(`http://localhost:5000/materialRecieved/view/hw/${id}`, '_blank');
};

const viewWooden = (id) => {
  window.open(`http://localhost:5000/materialRecieved/view/wooden/${id}`, '_blank');
};

const viewLights = (id) => {
  window.open(`http://localhost:5000/materialRecieved/view/lights/${id}`, '_blank');
};

const viewAccessories = (id) => {
  window.open(`http://localhost:5000/materialRecieved/view/accessories/${id}`, '_blank');
};

const viewChallan = (id) => {
  window.open(`http://localhost:5000/materialRecieved/view/challan/${id}`, '_blank');
};

const viewInvoice = (id) => {
  window.open(`http://localhost:5000/materialRecieved/view/invoice/${id}`, '_blank');
};

  const markAsFinal = async (id) => {
    try {
      const response = await axios.post(`http://localhost:5000/materialRecieved/Finalized/${id}`);
