...
const Purchase = () => {
  ...
  useEffect(() => {
    const fetchDrawings = async () => {
      ...
      try {
        const response = await axios.get(`http://localhost:5000/purchase/files/proj/${selectedProjectId}`);
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:5000/purchase/upload/${selectedProjectId}`,
        formData,
      ...
      const drawingsResponse = await axios.get(
        `http://localhost:5000/purchase/files/proj/${selectedProjectId}`
      );
  ...
  const downloadWooden = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/purchase/download/wooden/${id}`, {
        responseType: 'blob',
      });
  ...
  const downloadMainFile = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/purchase/download/mainFile/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
  ...
  const downloadHw = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/purchase/download/hw/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
  ...
  const downloadLights = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/purchase/download/lights/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
  ...
  const downloadAccessories = async (id) => {
    try {
      const response = await axios.get(`http://localhost:5000/purchase/download/accessories/${id}`, {
        responseType: 'blob',
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
  ...
  //   // window.open(`http://localhost:5000/purchase/view/MainUp/${id}`, '_blank');
  // };
  
  // const viewSitePic = (id) => {
  //   window.open(`http://localhost:5000/purchase/view/SitePic/${id}`, '_blank');
  // };
  
  const viewWooden = (id) => {
    window.open(`http://localhost:5000/purchase/view/Wooden/${id}`, '_blank');
  };

  const viewMainFile = (id) => {
    window.open(`http://localhost:5000/purchase/view/mainFile/${id}`, '_blank');
  };
  
  const viewHw = (id) => {
    window.open(`http://localhost:5000/purchase/view/hw/${id}`, '_blank');
  };
  
  const viewLights = (id) => {
    window.open(`http://localhost:5000/purchase/view/lights/${id}`, '_blank');
  };
  
  const viewAccessories = (id) => {
    window.open(`http://localhost:5000/purchase/view/accessories/${id}`, '_blank');
  };

  const markAsFinal = async (id) => {
    try {
      const response = await axios.post(`http://localhost:5000/purchase/Finalized/${id}`);
