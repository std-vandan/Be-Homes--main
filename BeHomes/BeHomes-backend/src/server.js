...
app.use("/workingDrawing/", require("./routes/workingDrawing"));
app.use("/shopDrawing/", require("./routes/shopDrawing"));
app.use("/finalDrawing/", require("./routes/finalDrawing"));
app.use("/purchase/", require("./routes/purchase"));
app.use("/materialRecieved/", require("./routes/materialRecieved"));
app.use("/snagList/", require("./routes/snagList"));
app.use("/dispatch/", require("./routes/dispatch"));
app.use("/installation/", require("./routes/installation"));
